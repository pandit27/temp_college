...
alter table enrollment add fees_paid enum('yes', 'no') default 'no';
...
update enrollment set dateOfEnrollment = '2018-01-15' where sid = '06';

update enrollment set dateOfEnrollment = current_date() where sid = '07';

update enrollment set dateOfEnrollment = '2018-01-02' where sid = '08';
